...
function IconSearchSm({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconEye({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconShare01({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconShare06({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconX({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconHeart({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconEyeClose({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconMinus({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconFilter({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
...
function IconCheck({ width, height, fill, stroke }: any) {
  return (
    <svg
      width={width || "24"}
      height={height || "24"}
